      ...
      <main className="flex flex-col md:flex-row flex-1">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-6 md:px-16 py-10 md:py-0">
          ...
          <p className="text-gray-600 mb-6 max-w-md">
            Tire dúvidas sobre calendário, matrícula, estágio e regulamento
            sem sair de casa. Disponível 24h, sem cadastro.
          </p>

          <button className="bg-[#B20000] hover:bg-[#7D0000] text-white px-5 py-3 rounded-md w-fit flex items-center gap-2">
            💬 Iniciar Atendimento
          </button>
        </div>
